...
public class PlayFabLogin : MonoBehaviour
{
    ...
    private void OnRegisterSuccess(RegisterPlayFabUserResult result)
    {
        ...
        ConnectionManager.Instance.StateMachine.TriggerTransition(ConnectionFSMStateEnum.StateEnum.START); 
    }
    ...
    private void OnLoginSuccess(LoginResult result)
    {
        ...
        ConnectionManager.Instance.TokenId = tokenId;
        ConnectionManager.Instance.Account = _account;
        UIManager.Instance.SystemTips("PlayFab 登录成功！ <" + idStr +"> <" + tokenId + ">", PanelSystemTips.MessageType.Success);
        ConnectionManager.Instance.StateMachine.TriggerTransition(ConnectionFSMStateEnum.StateEnum.CONNECTING); 
    }
