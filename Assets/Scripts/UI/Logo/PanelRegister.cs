...
#region 消息处理
    ...
    public void OnClickRegister()
    {
        ...
        // 修改状态
        ConnectionManager.Instance.StateMachine.TriggerTransition(ConnectionFSMStateEnum.StateEnum.PLAYFAB_REGISTER);
        // 注册PlayFab
        ConnectionManager.Instance.PlayFab.Register(strAccount, strPassword1);
    }
#endregion
}
