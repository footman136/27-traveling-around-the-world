...
#region 消息处理
    public void OnClickLogin()
    {
        ...
        Show(false);
        // 修改状态
        ConnectionManager.Instance.StateMachine.TriggerTransition(ConnectionFSMStateEnum.StateEnum.PLAYFAB_LOGIN);
        // 登录PlayFab
        ConnectionManager.Instance.PlayFab.Login(strAccount, strPassword);
    }
    ...
    public void OnClickRegister()
    {
        if (_panelRegister == null)
        {
            _panelRegister = UIManager.CreatePanel(UIManager.Instance.RootLogo, "", "UI/Logo/PanelRegister");
        }
